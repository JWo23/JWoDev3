		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title My UI5",
									"targetURL": "#stkjwostarterkit001-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"stkjwostarterkit001-display": {
								"semanticObject": "stkjwostarterkit001",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=stk.jwostarterkit001",
									"url": sap.ui.require.toUrl("stk/jwostarterkit001")
								}
							}
						}
					}
